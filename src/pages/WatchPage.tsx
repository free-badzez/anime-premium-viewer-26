                  ...
                  {episodes.map((episode) => (
                    <Button
                      ...
                      className={cn(
                        ...
                        currentEpisode === episode ? "bg-yellow-500 text-black hover:bg-yellow-600" : "bg-gray-800 hover:bg-gray-700"
                      )}
            ...
            <div className="relative w-full aspect-video bg-black flex-1">
              {isLoading ? (
                ...
                <div className="h-full w-full">
                  <iframe
                    src={`https://www.dailymotion.com/embed/video/${videoId}?autoplay=1&mute=${isMuted ? 1 : 0}`}
                    width="100%"
                    height="100%"
                    frameBorder="0"
